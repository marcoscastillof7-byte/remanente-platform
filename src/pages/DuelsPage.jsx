...
import { Swords, User, Play, Clock, Trophy, Check, X, Loader, Wrench } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center p-3 bg-red-100 rounded-full mb-4">
          <Swords className="w-10 h-10 text-danger" />
        </div>
        <h1 className="font-[Cinzel] text-3xl font-bold text-danger mb-2">Duelos Bíblicos</h1>
        <p className="text-gray-600 max-w-lg mx-auto">
          Reta a tus amigos a una batalla asíncrona de 5 preguntas. El mejor puntaje en menor tiempo gana.
        </p>
      </div>
